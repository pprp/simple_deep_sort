    ...
    for epoch in range(start_epoch, epochs):
        ...
        if save:
            ...
            if epoch > 0 and epoch % 10 == 0:
                torch.save(chkpt, weights + os.path.basename(cfg).split(".")[0]+'backup%g.pt' % epoch)

            # Delete checkpoint
            del chkpt

    dt = (time.time() - t0) / 3600
    print('%g epochs completed in %.3f hours.' % (now_epoch - start_epoch, dt))
    return results
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tiny-1cls.cfg', help='cfg file path')
